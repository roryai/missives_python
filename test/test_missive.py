...
db_controller = DatabaseController("/Users/rory/code/missives_python/missives_test.db")
...
def run_before_and_after_tests():
    db_controller.delete_all_missives()
    yield
...
def test_read_and_write_to_database(capsys):
    # insert one test missive
    db_controller.insert_missive(default_missive)

    # select missive and map db data to Missive
    missive_record = db_controller.select_missive_by_name(default_missive.name)
